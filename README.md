...
- `build.py` — turns `mirror/` into `docs/`: localizes CDN assets, cleans URLs, wires the newsletter form to Brevo, adds sitemap/robots/404
...
Rebuild: `CNAME=1 python3 build.py` (CNAME only once DNS points here).
